...
Project-specific commands are not known yet.

```bash
# install
# No install needed for the first prototype.
...
- Important folders: `work/` for drafts and experiments, `outputs/` for final deliverables.
- Things to avoid: Do not copy Valorant assets, names, maps, characters, UI, sounds, or proprietary content. Build an original tactical shooter prototype with similar general mechanics.
