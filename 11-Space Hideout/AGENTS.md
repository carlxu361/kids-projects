...
- Main goal: 重建一款以官方 Hide n Seek 信息逻辑为基线的原创桌面网页多人捉迷藏游戏
- Owner: 徐锦成
...
- Important folders: `apps/client`, `apps/server`, `packages/shared`, `docs`
- Things to avoid: Do not copy source code, art, maps, fonts, animation frames, audio, protocol assumptions, or gameplay systems from the old implementation or existing games.
